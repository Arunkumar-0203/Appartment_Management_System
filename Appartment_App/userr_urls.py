...
from Appartment_App.userr_views import IndexView, View_Appartment, Single_Apparment_View, View_Images, Book_Now, \
    View_Booking, Payment, Service, Add_Service, View_Service_Status, Feedback, View_Feedback, add_services, \
    View_pg_Booking, services, myhistory
...
urlpatterns = [
    ...
    path('view_pg_booking',View_pg_Booking.as_view()),
    ...
    path('add_services',add_services.as_view()),
