...
from Appartment_App.admin_views import IndexView, View_Owner, ApproveView, RejectView, Approve_Owner_View, View_User, \
    ...
    view_approve_appartment, view_appartments_accepted, view_appartments_reject
...
urlpatterns = [
    ...
    path('view_appartments',view_approve_appartment.as_view()),
    path('view_appartments_accepted',view_appartments_accepted.as_view()),
    path('view_appartments_reject',view_appartments_reject.as_view()),
