...
class add_appartment(models.Model):
    ...
    status= models.CharField(max_length=100,null=True,default='notapproved')
...
class book_now(models.Model):
    ...
    status2 = models.CharField(max_length=100, null=True,default='notapproved')
    facility = models.CharField(max_length=500, null=True)
    facility_amount = models.IntegerField(max_length=500, null=True)
