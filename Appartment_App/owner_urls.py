...
from Appartment_App.owner_views import IndexView, Add_Appartment, View_Appartment, View_Images, Single_Apparment_View, \
    View_Booking, View_Services, View_Payment, Feedback, View_Feedback, remove_services, View_pgBooking, approved
...
urlpatterns = [
    ...
    path('remove_services',remove_services.as_view()),
    path('View_pgBooking',View_pgBooking.as_view()),
    path('approved',approved.as_view())
